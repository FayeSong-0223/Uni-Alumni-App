...
class User(AbstractUser):
    ...
    # Holds the candidate secret generated by /2fa/setup/ until the user
    # proves they can read codes from it via /2fa/enable/. Keeping it
    # separate from `totp_secret` means starting setup never invalidates a
    # working authenticator app.
    pending_totp_secret = models.CharField(max_length=32, blank=True, default='')
